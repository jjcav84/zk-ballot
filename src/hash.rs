...
//!
//! Security: Production-standard Poseidon parameters for width 3 over BN254.
//! 8 full rounds + 57 partial rounds = 65 total rounds, matching the
//! parameters generated by the official Poseidon SageMath script:
//!   sage generate_parameters_grain.sage 1 0 254 3 8 57 <BN254 modulus>
//! This provides 128-bit security with margin. Forging requires inverting
//! Poseidon over BN254 (assumed hard under the standard Poseidon security
//! assumptions).
//!
...
fn round_constants() -> Vec<[Fr; WIDTH]> {
    ...
    for _ in 0..(FULL_ROUNDS + PARTIAL_ROUNDS) {
        ...
        for j in 0..WIDTH {
            ...
            round_c[j] = Fr::from_bytes(&bytes).unwrap_or(Fr::zero());
        }
